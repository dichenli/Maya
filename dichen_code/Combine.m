...
feat_train1 = [-prob_word1, prob_boosting1(:, 2), prob_img1, prob_LBP_img1, -prob_img_feat1];
feat_train2 = [-prob_word2, prob_boosting2(:, 2), prob_img2, prob_LBP_img2, -prob_img_feat2];
feat_train3 = [-prob_word3, prob_boosting3(:, 2), prob_img3, prob_LBP_img3, -prob_img_feat3];
